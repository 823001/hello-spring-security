...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (productRepository.count() == 0) {
            ...
            productRepository.save(new Product("Git & GitHub 협업", 18000, "브랜치 전략 과 Pull Request 가이드", 60));
            ...
            productRepository.save(new Product("삼성전자 갤럭시 S25", 1290000, "최신 플래그 십 스마트폰", 100));
            productRepository.save(new Product("삼성전자 갤럭시 탭 S10", 890000, "고해상도 AMOLED 태블릿", 45));
            productRepository.save(new Product("LG 그램 17 노트북", 1890000, "초경량 17인 치 업무용 노트북", 8));
            ...
            productRepository.save(new Product("로지텍 MX Master 3S", 129000, "무선 고정 밀 업무용 마우스", 75));

            productRepository.save(new Product("삼성전자 65인치 QLED TV", 1590000, "Neo QLED 4K 스마트 TV", 5));
            productRepository.save(new Product("다이슨 V15 청소기", 890000, "레이저 먼 지 감지 무선 청소기", 18));
